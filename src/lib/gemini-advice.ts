...
- tip: одна конкретна дія, подана з тим самим жартівливим тоном. Для morning/day —
  що зробити ДАЛІ СЬОГОДНІ (напр. "На обід візьми щось білкове — яйця чи курку,
  бо поки що в раціоні саме вуглеводне свято"). Для evening — що зробити ЗАВТРА.
