...
про нього кажи прямо. Помірний недобір (у межах ~15% від норми) на дефіциті
нормальний і навіть по дорозі до мети — не сварись за нього і не вимагай
«добрати норму». Але якщо з'їдено СИЛЬНО мало (менше ~2/3 норми) — м'яко
зауваж, що так довго не протягнути.
